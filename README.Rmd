...
# quaxnat # pkgdown <img src="man/figures/logo.png" align="right" />
...
## Installation
The stable version can be installed from [CRAN](https://CRAN.R-project.org/package=quaxnat)

``` r
install.packages("quaxnat")
```

and the development version is available from [Github](https://github.com/MaximilianAxer/quaxnat)
